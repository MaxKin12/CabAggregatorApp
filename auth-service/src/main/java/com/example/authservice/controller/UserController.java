...
public class UserController {
    ...
    @PostMapping("/refresh")
    public ResponseEntity<AuthResponse> refresh(@RequestBody UserRefreshTokenRequest refreshRequest) {
        AuthResponse authResponse = userService.refreshToken(refreshRequest);
        return ResponseEntity.status(HttpStatus.OK).body(authResponse);
    }

    @PostMapping("/logout")
    public ResponseEntity<Void> logout(@RequestBody UserRefreshTokenRequest refreshRequest) {
