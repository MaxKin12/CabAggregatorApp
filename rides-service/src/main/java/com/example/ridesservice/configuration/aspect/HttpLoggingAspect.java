package com.example.ridesservice.configuration.aspect;

import static com.example.ridesservice.utility.constants.InternationalizationExceptionVariablesConstants.INVALID_SERIALISATION_ATTEMPT;
import static com.example.ridesservice.utility.constants.LogMessagesTemplate.EXCEPTION_RESPONSE_LOG_TEMPLATE;
import static com.example.ridesservice.utility.constants.LogMessagesTemplate.FEIGN_CLIENT_RESPONSE_LOG_TEMPLATE;
import static com.example.ridesservice.utility.constants.LogMessagesTemplate.REQUEST_LOG_TEMPLATE;
import static com.example.ridesservice.utility.constants.LogMessagesTemplate.RESPONSE_LOG_TEMPLATE;
import static com.example.ridesservice.utility.constants.LogMessagesTemplate.SERIALISATION_DELIMITER;
...
public class HttpLoggingAspect {
    ...
    @AfterReturning(
            pointcut = "(within(com.example.ridesservice.client.driver.DriverClient+)" +
